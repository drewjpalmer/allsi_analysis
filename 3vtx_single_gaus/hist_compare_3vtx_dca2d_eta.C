{
	...
	TCanvas *mom_canvas_Beast_2vtx = new TCanvas("mom_canvas_Beast_2vtx", "Transverse DCA resolution in p bins for 3.0T Beast map with 2 vertexing layers");
	mom_canvas_Beast_2vtx->Divide(4,2);

	TCanvas *mom_canvas_sPHENIX_2vtx = new TCanvas("mom_canvas_sPHENIX_2vtx", "Transverse DCA resolution in p bins for 1.4T sPHENIX map with 2 vertexting layers");
	mom_canvas_sPHENIX_2vtx->Divide(4,2);

	TCanvas *mom_canvas_Beast_3vtx = new TCanvas("mom_canvas_Beast_3vtx", "Transverse DCA resolution in p bins for 3.0T Beast map with 3 vertexing layers");
	mom_canvas_Beast_3vtx->Divide(4,2);

	TCanvas *mom_canvas_sPHENIX_3vtx = new TCanvas("mom_canvas_sPHENIX_3vtx", "Transverse DCA resolution in p bins for 1.4T sPHENIX map with 3 vertexing layers");
	...
	for (int i = 0; i < 8; i++){
		...
		sigmab[i]->SetTitle(Form("3-vtx/2-vtx  #eta: %.1f - %.1f;p [GeV/c];3-vtx / 2-vtx Transverse DCA Resolution", (i * .5), ((i * .5) + .5))); 
		...
		sigmas[i]->SetTitle(Form("3-vtx/2-vtx  #eta: %.1f - %.1f ;p [GeV/c];3-vtx / 2-vtx Transverse DCA Resolution", (i * .5), ((i * .5) + .5))); 
		...
		sigma1[i]->SetTitle(Form("3.0T 2-vtx  #eta: %.1f - %.1f ;p [GeV/c];3.0T 2-vtx Transverse DCA Resolution [#mum]", (i * .5), ((i * .5) + .5))); 
		...
		sigma2[i]->SetTitle(Form("1.4T 2-vtx  #eta: %.1f - %.1f;p [GeV/c];1.4T 2-vtx Transverse DCA Resolution [#mum]", (i * .5), ((i * .5) + .5))); 
		...
		sigma3[i]->SetTitle(Form("3.0T 3-vtx  #eta: %.1f - %.1f;p [GeV/c];3.0T 3-vtx Transverse DCA Resolution [#mum]", (i * .5), ((i * .5) + .5))); 
		...
		sigma4[i]->SetTitle(Form("1.4T 3-vtx  #eta: %.1f - %.1f;p [GeV/c];1.4T 3-vtx Transverse DCA Resolution [#mum]", (i * .5), ((i * .5) + .5))); 
