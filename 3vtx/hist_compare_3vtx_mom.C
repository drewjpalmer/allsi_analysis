{
	...
	for (int i = 0; i < 6; i++){
		...
		sigmab[i]->SetTitle(Form("3-vtx/2-vtx  p: %d - %d GeV;#eta;3-vtx / 2-vtx Momentum Resolution", (i * 5), ((i * 5) + 5))); 
		...
		sigmas[i]->SetTitle(Form("3-vtx/2-vtx  p: %d - %d GeV;#eta;3-vtx / 2-vtx Momentum Resolution", (i * 5), ((i * 5) + 5))); 
